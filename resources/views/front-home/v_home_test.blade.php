            ...
            <div class="page-title-box">
                <div class="float-right">
                   <select class="select2 form-control mb-3 custom-select select2-hidden-accessible" style="width: 100%; height:36px;" tabindex="-1" aria-hidden="true">
                    ...
                    <optgroup label="Servicios"><option value="AK">Alaska</option><option value="HI">Hawaii</option>
                    </optgroup>
                    <optgroup label="Servicios publicos"><option value="CA">California</option><option value="NV">Nevada</option><option value="OR">Oregon</option><option value="WA">Washington</option></optgroup>
                    </select>
                </div>
...
<script>
    ...
    if (navigator.geolocation) {
        ...
        var pos = {
            ...
            DrowCircle(myOptions, map, pos, km);
        }, function() {
    ...
    function RelatedLocationAjax() {
        ...
        $.ajax({
            type: "POST",
            url: "/location/getServ",
            dataType: "json",
            data:"data="+ '{ "lat":"'+ lat.value+'", "lng": "'+lng.value+'", "id": "'+ServiceId.value+'" }',
    ...
    for (i = 0; i < locations.length; i++) {
        marker = new google.maps.Marker({
            ...
            "<tr>\n" +
            "<td><a>Nombre:</a></td>\n" +
            "<td><input disabled id='manual_description' placeholder='Description' value='"+locations[i][3]+"'></td></tr>\n" +
            "<td><a>Detalle:</a></td>\n" +
